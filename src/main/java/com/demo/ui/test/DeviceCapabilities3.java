...
public class DeviceCapabilities3 {
...
//    public static final String APPIUM_SAUCE_URL = ("http://" + System.getenv("SAUCE_USERNAME") + ":" + System.getenv("SAUCE_ACCESS_KEY") + "@ondemand.saucelabs.com:80/wd/hub");
    ...
    public enum DevicePlatform {
        ANDROID, IOS, MOBILE_WEB, SAUCELABS, SAUCELABS_IOS, SAUCELABS_ANDROID
    }
    ...
    public RemoteWebDriver getDriver(String platform, String device, String os_version) throws Exception {
        ...
        } else if (platform.equalsIgnoreCase("sauce ios")) {
            devicePlatform = DevicePlatform.SAUCELABS_IOS;
        } else if (platform.equalsIgnoreCase("sauce android")) {
            devicePlatform = DevicePlatform.SAUCELABS_ANDROID;
        } else {
...
//                                capabilities));
                        ...
                        break;
                    case IPHONE_X:
                        driver = new IOSDriver(SAUCE_URL, this.getCapabilitiesForIphoneXSauceLabs()); // change
                        break;
                }
                break;

            case SAUCELABS_ANDROID:
                switch (androidDevice) {
                    case NEXUS_5X:
...
//        caps.setCapability("app","sauce-storage:Wikipedia.zip");
        caps.setCapability("app","sauce-storage:wiki_ios");
        return caps;
    }
